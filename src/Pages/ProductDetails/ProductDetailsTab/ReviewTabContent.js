...
const ReviewTabContent = ({ data }) => {
	...
	const [sendReviewInfo, { isSuccess, isError, isLoading }] = useAddReviewMutation();
			...
			>
							...
							<div className="flex items-start justify-center mb-10" key={review._id}>
								...
								<div className="basis-5/6 !mt-0">
									<div className="flex items-center justify-start gap-1 text-primary text-lg mb-2">
										<ReactStars
											count={5}
											value={review?.ratingStar === 0 ? 1 : review?.ratingStar}
											edit={false}
											size={24}
											isHalf={true}
											fullIcon={<AiFillStar />}
				...
				<div>
					...
					<form className="mb-4" onSubmit={handleSubmit}>
						...
						<button type="submit" className="btn-primary mt-5" disabled={isLoading}>
							Submit
						</button>
					</form>
				</div>
