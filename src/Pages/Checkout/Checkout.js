...
import { personalInfo, shippingInfo, shippinCost, paymentInfo } from "./userData";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 px-5 lg:px-0">
            ...
            <div className="col-span-3 lg:col-span-2">
              ...
              <div className="grid gric-cols-1 lg:grid-cols-2 gap-5 mb-5">
                <Link to="/shop" className="bg-gray-200 text-black py-2 px-4 flex items-center justify-center rounded-md hover:bg-gray-300">
